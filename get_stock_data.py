...
class Populate:
    ...
    def __init__(self):
        self.companies_investigated_n_found_good = []
    #time.sleep(2)
    def company_page_analysis(self, stock_company):
        try:
            ...
            if True:
                ...
                if True:
                    ...
                    if True:
                        self.companies_investigated_n_found_good.append(stock_company)
...
def companies_to_investigate():
    companies = []
    f = open('G:\\Python\\projects\\stock_analysis_kivy_android\\update005\\top_500_companies.txt', 'r')
    for company in f:
